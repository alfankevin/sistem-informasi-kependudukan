...
@section('content')
    <section class="p-3">
        <form action="{{ route('persuratan.generatePDF') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group input-group-md mb-3">
                <label class="input-group-text col-2" for="rt">RT/RW</label>
            ...
            <div class="input-group input-group-md mb-3">
                ...
                <select name="jenis_surat" id="jenis_surat" class="form-select" required>
                    ...
                    <option value="skk" {{ old('jenis_surat') == 'skk' ? 'selected' : '' }}>Surat Pengantar Kartu
                        Keluarga</option>
                    <option value="sktp" {{ old('jenis_surat') == 'sktp' ? 'selected' : '' }}>Surat Pengantar Akta
                        Kematian</option>
                    <option value="skk" {{ old('jenis_surat') == 'skk' ? 'selected' : '' }}>Surat Keterangan Boro Kerja
                    </option>
                </select>
            </div>
            <div class="input-group input-group-md mb-3">
                <label class="input-group-text col-2" for="Keperluan">Keperluan</label>
                <input type="text" class="form-control" name="keperluan" value="{{ old('keperluan') }}" required>
            </div>

            <div class="input-group mb-3">
                <label for="signature" class="input-group-text col-2">Tanda Tangan Digital</label>
            ...
            <div class="input-group input-group-md mb-3">
                ...
                <input type="file" name="ktp" id="ktp" class="form-control" accept="image/*" required>
            </div>
