                            ...
                            <div class="card card-rt" style="height: 370px">
                                ...
                                <div class="card-body">
                                    <div class="mb-4">
                                        ...
                                        <div class="progress" data-height="3">
                                            <div class="progress-bar" role="progressbar"
                                                data-width="{{ $persenRt1 }}%" aria-valuenow="25" aria-valuemin="0"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="progress" data-height="3">
                                            <div class="progress-bar" role="progressbar"
                                                data-width="{{ $persenRt2 }}%" aria-valuenow="25" aria-valuemin="0"
                                                aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="progress" data-height="3">
                                            <div class="progress-bar" role="progressbar"
                                                data-width="{{ $persenRt3 }}%" aria-valuenow="25" aria-valuemin="0"
                                                aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="progress" data-height="3">
                                            <div class="progress-bar" role="progressbar"
                                                data-width="{{ $persenRt4 }}%" aria-valuenow="25" aria-valuemin="0"
                                                aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="progress" data-height="3">
                                            <div class="progress-bar" role="progressbar"
                                                data-width="{{ $persenRt5 }}%" aria-valuenow="25" aria-valuemin="0"
                                                aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
